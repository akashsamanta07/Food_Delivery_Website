...
function Order({prop}){
  ...
  return (
    <div className={`w-[90vw]  md:w-[50vw] text-center p-[1rem] md:p-[3rem]  bg-white absolute top-[10px] overflow-scroll ${order === 1 ? "right-[10px]" : "right-[-90vw] md:right-[-50vw]"} transition-all duration-200 rounded-lg`}>
